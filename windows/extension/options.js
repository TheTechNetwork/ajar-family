 ...
 * parent setup word. See the long comment on the parent lock below for exactly
 * what that gate does and does not protect against.
 */
...
const clearLocalPolicy = () =>
  ext.storage.local.remove(["snapshot", "clockAnchor", "ajarAsks"]);
